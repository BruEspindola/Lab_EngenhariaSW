...
//        String path = "/com/gn/theme/css/";
        ...
        stylesheets.addAll(
                getClass().getResource(path + "theme/css/fonts.css").toExternalForm(),
                getClass().getResource(path + "theme/css/material-color.css").toExternalForm(),
                getClass().getResource(path + "theme/css/skeleton.css").toExternalForm(),
                getClass().getResource(path + "theme/css/" + theme).toExternalForm(),
                getClass().getResource(path + "theme/css/bootstrap.css").toExternalForm(),
                getClass().getResource(path + "theme/css/simple-green.css").toExternalForm(),
                getClass().getResource(path + "theme/css/shape.css").toExternalForm(),
                getClass().getResource(path + "theme/css/typographic.css").toExternalForm(),
                getClass().getResource(path + "theme/css/helpers.css").toExternalForm(),
                getClass().getResource(path + "theme/css/master.css").toExternalForm()
        );
