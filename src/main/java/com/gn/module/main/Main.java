...
public class Main implements Initializable {
    ...
    @FXML private Button servico;
    @FXML private Button funcionario;
    @FXML private Button produto;
    @FXML private Button cliente;
    ...
    private void addSubPop() throws Exception {
        popup.setContentNode(FXMLLoader.load(getClass().getResource("/module/main/Popover.fxml")));
    ...
    private void addEvent(Node node) {
        ...
        scrollPane.getStylesheets().add(getClass().getResource("/theme/css/custom-scroll.css").toExternalForm());
...
//        Popover.ctrl.options.getChildren().clear();
    ...
    private void barInitial(){
        ...
        views.getChildren().removeAll(home, pedido, servico, funcionario, produto, cliente, about);
        views.getChildren().add(home);
        views.getChildren().add(pedido);
        views.getChildren().add(servico);
        views.getChildren().add(funcionario);
        views.getChildren().add(produto);
        views.getChildren().add(cliente);
        views.getChildren().add(about);
        home.setContentDisplay(ContentDisplay.LEFT);
        pedido.setContentDisplay(ContentDisplay.LEFT);
        servico.setContentDisplay(ContentDisplay.LEFT);
        funcionario.setContentDisplay(ContentDisplay.LEFT);
        produto.setContentDisplay(ContentDisplay.LEFT);
        cliente.setContentDisplay(ContentDisplay.LEFT);
        about.setContentDisplay(ContentDisplay.LEFT);
        home.setAlignment(Pos.CENTER_LEFT);
        pedido.setAlignment(Pos.CENTER_LEFT);
        servico.setAlignment(Pos.CENTER_LEFT);
        funcionario.setAlignment(Pos.CENTER_LEFT);
        produto.setAlignment(Pos.CENTER_LEFT);
    ...
    private void loadContentPopup(){
        try {
            popContent = FXMLLoader.load(getClass().getResource("/module/main/Config.fxml"));
            popConfig.getRoot().getStylesheets().add(getClass().getResource("/theme/css/poplight.css").toExternalForm());
    ...
    private void servico() {
        ...
        body.setContent(ViewManager.getInstance().get("servicoController"));
    }

    @FXML
    private void funcionario() {
        title.setText("Funcionário");
    ...
    private void relatorio(){
        ...
        body.setContent(ViewManager.getInstance().get("relatorioController"));
    }
...
//    }
    ...
    private void openMessages(){
        if(!pop.isShowing()){
            ...
            avatar1.setImage(new Image(getClass().getResource("/module/media/man.png").toExternalForm()));
            avatar2.setImage(new Image(getClass().getResource("/module/media/woman.png").toExternalForm()));
            avatar3.setImage(new Image(getClass().getResource("/module/media/man.png").toExternalForm()));
            ...
            listView.getStylesheets().add(getClass().getResource("/theme/css/custom-scroll.css").toExternalForm());


            pop.getRoot().getStylesheets().add(getClass().getResource("/theme/css/poplight.css").toExternalForm());
    ...
    private void openNotification(){
      if(!pop.isShowing()){
            ...
            avatar1.setImage(new Image(getClass().getResource("/module/media/warning-35.png").toExternalForm()));
            avatar2.setImage(new Image(getClass().getResource("/module/media/error-35.png").toExternalForm()));
            avatar3.setImage(new Image(getClass().getResource("/module/media/notification-35.png").toExternalForm()));
